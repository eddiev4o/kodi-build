...
INSTALL_NAME_DIR=
SRC_PATH=/home/eddie/Documents/kodi-build/build/ffmpeg/src/ffmpeg
SRC_LINK=src
...
CFLAGS=  -DPLATFORM_SETTINGS_FILE=x11.xml -Wall -std=c11 -fomit-frame-pointer -fPIC -pthread -I/usr/include/p11-kit-1 -I/usr/include/alsa    -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS= -std=c++11 -DPLATFORM_SETTINGS_FILE=x11.xml -Wall -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -DPLATFORM_SETTINGS_FILE=x11.xml -Wall -fPIC
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=/usr/bin/cc
DOXYGEN=doxygen
LDFLAGS= -fuse-ld=gold  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
SLIBSUF=.so
EXESUF=
EXTRA_VERSION="kodi-4.0.3-Leia-Beta5"
CCDEP=
CXXDEP=
CCDEP_FLAGS=
ASDEP=
...
EXTRALIBS-avfilter=-pthread -lm -lva
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -lgnutls
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -lva
